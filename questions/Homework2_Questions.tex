...
\paragraph{E1:} Let's look again at the webcam Fourier decomposition demo which Srinath showed in class. Let's run it in our CSCI 1430 virtual environment \emph{preferably on a computer with a webcam}, from within the 'questions' directory.
